...
def main():
    ...
    for epoch in range(1, epochs+1):
        ...
        # Validate the model
        epoch_valid_loss = epoch_step("VALIDATE", model, device, valid_loader, Focal_Loss, Dice_Loss, Iou_Loss)
    ...
    # Test the model
    test_loss = epoch_step("TEST", model, device, test_loader, Focal_Loss, Dice_Loss, Iou_Loss)
    logger.info(f'\nTest Loss: {test_loss}')
